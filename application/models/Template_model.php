...
class Template_model extends CI_Model
{
    ...
    public function find_templates_by_word_picture($word_count, $pictures_count, $article)
    {
        ...
        if (!$contain_sponsorship_ad) {
            $contain_sponsorship_ad = 0;
        }
        ...
        } elseif ($article_type_name == 'Sponsor Index' or $article_type_name == 'Real Estate Resource' or $article_type_name == 'Resident Business Guide') {
